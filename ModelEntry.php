...
if($verify !== NULL) {
	...
	$sysmessage = "This model already has been logged. Please check the model number.";
	$jsalert = "<script type = text/javascript> alert ('{$modelnumber} already exists!'); </script>";
...
if (isset($_POST['Check64'])) {
	...
	$sysmessage = "$modelnumber has been logged.";
	...
	$jsalert = "<script type = text/javascript> alert ('Please fill in all fields before trying to save the model entry.'); </script>";
	$sysmessage = "Please fill in the following information: " . join(", ", $emptymodels) . ".";
